...
const studentProfile = {
  // ข้อมูลพื้นฐาน
  studentId: "66022286", // เปลี่ยนเป็นรหัสนิสิตของคุณ
  name: "อภิวัฒน์ แสงรัศมี", // เปลี่ยนเป็นชื่อจริงของคุณ
  nickname: "ต้นกล้า", // ชื่อเล่นของคุณ
  year: 3, // ชั้นปี
  major: "Computer Engineering",

  // ข้อมูลติดต่อ (ถ้าต้องการ)
  contact: {
    email: "tonkar595@gmail.com",
    github: "tonkar595",
  },
...
if (require.main === module) {
  ...
  console.log("Age (born 2003):", studentProfile.calculateAge(2005));
  console.log("\n=== Todo List ===");
  console.log(
    studentProfile.createTodoList(["เรียน Git Flow", "ทำ workshop", "ส่งงาน"])
  );
}
